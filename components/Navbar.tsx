...
import { Bs0Circle, BsFillArrowDownRightCircleFill, BsFillArrowRightCircleFill } from 'react-icons/bs'
  ...
  return (
    <header>
          ...
          <div className='flex items-center justify-between px-6 py-6 cursor-default'>
            <Link href='/' className='uppercase text-[1.5rem] z-50 ml-4'>Vimal <span className='text-gray-400'>Kumar</span> </Link>
